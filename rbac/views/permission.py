...
def distribute_permissions(request):
    ...
    :return:
    """
    # http://127.0.0.1:8001/rbac/distribute/permissions/?uid=1&rid=8
    ...
    if rid:
        ...
        # print("role_has_permissions: ", role_has_permissions)
    else:
        role_has_permissions = []

    role_has_permissions_dict = {item['permissions']: None for item in role_has_permissions}
    # print("role_has_permissions_dict: ", role_has_permissions_dict)


    # 菜单
    queryset = models.Menu.objects.values('id', 'title')
    # print(queryset)
    # [{'id': 1, 'title': '信息管理'}, {'id': 2, 'title': '用户信息'}, {'id': 3, 'title': '权限管理'}, {'id': 7, 'title': '测试'},
     # {'id': 8, 'title': 'sdfg'}]
    menu_dict = {}
    for item in queryset:
        item['children'] = []
        menu_dict[item['id']] = item  # {1: {'id': "title": "...", "children": []}, }
